...
(function (e, t, n) {
  ...
  L.Label = L.Class.extend({
    ...
    onAdd: function (e) {
      ...
      e.on("moveend", this._onMoveEnd, this).on(
        "viewreset",
        this._onViewReset,
        this
      );
      if (this._animated) {
        e.on("zoomanim", this._zoomAnimation, this);
      }
    ...
    updateZIndex: function (e) {
      ...
      if (this._container && this._zIndex) {
        this._container.style.zIndex = e;
      }
    },
    setOpacity: function (e) {
      this.options.opacity = e;
      if (this._container) {
        L.DomUtil.setOpacity(this._container, e);
      }
    },
    ...
    _setPosition: function (e) {
      ...
      if (s === "right" || (s === "auto" && i.x < r.x)) {
        L.DomUtil.addClass(n, "leaflet-label-right");
        L.DomUtil.removeClass(n, "leaflet-label-left");
        e = e.add(u);
      } else {
        L.DomUtil.addClass(n, "leaflet-label-left");
        L.DomUtil.removeClass(n, "leaflet-label-right");
        e = e.add(L.point(-u.x - o, u.y));
      }
    ...
    _initInteraction: function () {
      ...
      for (var n = 0; n < t.length; n++) {
        L.DomEvent.on(e, t[n], this._fireMouseEvent, this);
      }
    },
    _removeInteraction: function () {
      ...
      var e = this._container,
        t = ["dblclick", "mousedown", "mouseover", "mouseout", "contextmenu"];
      L.DomUtil.removeClass(e, "leaflet-clickable");
      L.DomEvent.off(e, "click", this._onMouseClick, this);
      for (var n = 0; n < t.length; n++) {
        L.DomEvent.off(e, t[n], this._fireMouseEvent, this);
      }
    },
  ...
  L.BaseMarkerMethods = {
    ...
    bindLabel: function (e, t) {
      ...
      r = r.add(L.Label.prototype.options.offset);
      if (t && t.offset) {
        r = r.add(t.offset);
      }
      t = L.Util.extend({ offset: r }, t);
      this._labelNoHide = t.noHide;
      if (!this.label) {
      ...
      this.label = new L.Label(t, this).setContent(e);
      return this;
    },
  ...
  L.Icon.Default.mergeOptions({ labelAnchor: new L.Point(9, -20) });
  ...
  L.Marker.include({
    ...
    _updateZIndex: function (e) {
      ...
      if (this.label) {
        this.label.updateZIndex(t);
      }
    },
    _originalSetOpacity: L.Marker.prototype.setOpacity,
    setOpacity: function (e, t) {
      this.options.labelHasSemiTransparency = t;
      this._originalSetOpacity(e);
    },
    ...
    _updateOpacity: function () {
      ...
      if (this.label) {
        this.label.setOpacity(
          this.options.labelHasSemiTransparency ? this.options.opacity : e
        );
      }
    },
    ...
    setLatLng: function (e) {
      ...
      return this._originalSetLatLng(e);
    },
  });
  L.CircleMarker.mergeOptions({ labelAnchor: new L.Point(0, 0) });
  L.CircleMarker.include(L.BaseMarkerMethods);
  L.Path.include({
    bindLabel: function (e, t) {
      if (!this.label || this.label.options !== t) {
        this.label = new L.Label(t, this);
      }
      this.label.setContent(e);
